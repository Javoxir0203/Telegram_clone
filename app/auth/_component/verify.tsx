...
const Verify = () => {
	...
	return (
		<div className='w-full'>
			<p className='text-center text-muted-foreground text-sm'>We have sent you an email with a verification code to your email address. Please enter the code below</p>
			<Form {...form}>
