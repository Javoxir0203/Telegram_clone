			...
			<Popover>
				...
				<PopoverContent className='w-80 p-0'>
					<h2 className=' pt-2 pl-2 text-muted-foreground'>
						Settings: <span className='text-white'>info@javoxir.ac</span>
					</h2>
					<Separator className='my-2' />
					<div className='flex flex-col space-y-3'>
						<div className='flex items-center justify-between p-2 hover:bg-secondary cursor-pointer' onClick={() => setIsProfileOpen(true)}>
			...
			<Sheet open={isProfileOpen} onOpenChange={setIsProfileOpen}>
				<SheetContent side={'left'} className='w-80 p-2'>
					<SheetHeader>
						...
						<SheetDescription>Setting up your profile will help you connect with your friends and family easily</SheetDescription>
					</SheetHeader>
